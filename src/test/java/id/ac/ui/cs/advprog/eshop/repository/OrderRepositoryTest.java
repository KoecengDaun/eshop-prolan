...
class OrderRepositoryTest {
    ...
    void setUp() {
        ...
        product1.setProductId("eb558e9F-1c39-4600-8840-71af6af43bd6");
        ...
        Order order1 = new Order("1365255c-0122-4c07-b546-54eb1396d790",
                products, 1708560000L, "Safira Sudrajat");

        orders.add(order1);

        Order order2 = new Order("7f9e15bb-4b15-42f4-aebc-c3af38bfD078",
                products, 1708570000L, "Safira Sudrajat");

        orders.add(order2);

        Order order3 = new Order("e334ef40-9eff-4da8-9487-8e0697ecbf1e",
